(function(mod) {
  ...
  "google": {
    "visualization": {
      "DataTable": {
        "!doc": "Represents a two-dimensional, mutable table of values. To make a read-only copy of a\n  DataTable (optionally filtered to show specific values, rows, or columns), create a\n  DataView.",
        ...
        "prototype": {
          ...
          "clone": {
            ...
            "!doc": "Returns a clone of the data table. The result is a deep copy of the data table except for the\n      cell properties,\n      row properties,\n      table properties and\n      column properties, which are shallow copies; this\n      means that non-primitive properties are copied by reference, but primitive properties are\n      copied by value.",
            "!url": "https://developers.google.com/chart/interactive/docs/reference#DataTable"
          },
          "getColumnId": {
            "!type": "fn() -> string",
      ...
      "ChartWrapper": {
        ...
        "prototype": {
          ...
          "setQuery": {
            "!type": "fn()",
            "!doc": "Sets a query string, if this chart queries a data source. You must also set the data source\n      URL if specifying this value.",
            "!url": "https://developers.google.com/chart/interactive/docs/reference#ChartWrapper"
          },
          "setRefreshInterval": {
            "!type": "fn()",
            "!doc": "Sets the refresh interval for this chart, if it queries a data source.\n      You must also set a data source URL if specifying this value. Zero indicates no refresh.",
            "!url": "https://developers.google.com/chart/interactive/docs/reference#ChartWrapper"
          },
          "setOption": {
            "!type": "fn()",
      ...
      "ChartEditor": {
        "!doc": "The ChartEditor class is used to open an in-page dialog box that enables a user to\n  customize a visualization on the fly.",
        "!url": "https://developers.google.com/chart/interactive/docs/reference#ChartEditor",
        "prototype": {
          "openDialog": {
            "!type": "fn() -> +null",
      ...
      "GadgetHelper": {
        "!doc": "A helper class to simplify writing Gadgets that use the Google\n  Visualization API.",
      ...
      "Query": {
        "!doc": "Represents a query that is sent to a data source.",
      ...
      "QueryResponse": {
        "!doc": "Represents a response of a query execution as received from the data source. An instance of this\n  class is passed as an argument to the callback function that was set when\n  Query.send was called.",
  ...
  "Data": {
    "!doc": "The google.visualization.data namespace holds static methods to perform SQL-like\n  operations on DataTable objects, for example joining them or grouping by column\n  value.",
    "!url": "https://developers.google.com/chart/interactive/docs/reference#Data"
  },
  "Formatters": {
    "!doc": "The Google Visualization API provides formatters that can be used to reformat data in a\n  visualization. These formatters change the formatted value of the specifiedcolumn in all rows.\n  Note that it does not modify the underlying values; just the formatted values. So, for example,\n  the displayed value would be \"$1,000.00\" but the underlying value would still be\n  \"1000\". Formatters can only affect one column at a time; to reformat multiple columns,\n  apply a formatter to each column that you want to change.",
    "!url": "https://developers.google.com/chart/interactive/docs/reference#Formatters"
  },
  "Query": {
    "!doc": "The following objects are available to send queries for data to an external data source, such as\n  Google Spreadsheets.",
    "!url": "https://developers.google.com/chart/interactive/docs/reference#Query"
  },
  "Error": {
    "!doc": "The API provides several functions to help you display custom error messages to your users. To\n  use these functions, provide a container element on the page (typically a\n  <div>), into which the API will draw a formatted error message. This container\n  can be either the visualization container element, or a container just for errors. If you specify\n  the visualization containe element, the error message will be displayed above the visualization.\n  Then call the appropriate function below to show, or remove, the error message.",
    "!url": "https://developers.google.com/chart/interactive/docs/reference#Error"
  },
  "Events": {
    "!doc": "Most visualizations fire events to indicate something has occured. As a user of the chart, you\n  would often want to listen to these events. If you\n  code your own visualization, you might also want\n  to trigger such events on your own.",
    "!url": "https://developers.google.com/chart/interactive/docs/reference#Events"
  },
  "Standard": {
    "!doc": "Every visualization should expose the following set of required and optional methods and\n  properties. However, note that there is no type checking to enforce these standards, so you should\n  read the documentation for each visualization.",
    "!url": "https://developers.google.com/chart/interactive/docs/reference#Standard"
  },
  "Assorted": {
    "!doc": "This section contains various useful methods exposed in the google.visualization\n  namespace.",
